                ...
                <Accordion key="addPackage">
                    <div>
                        <Box height="10.5vh" mr={6}>
                            ...
                            >
                                <Typography
                                    ...
                                    style={{ fontWeight: 800, flexGrow: 10 }}
                                >
                                    Añadir paquete{" "}
                                </Typography>
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText>Datos del nuevo paquete</DialogContentText>
                        ...
                        <Accordion key={pack.id}>
                                ...
                                <Container>
                                    <Box height="6vh">
                                        ...
                                        >
                                            ...
                                            <Button
                                                onClick={(e) => handleClickOpenEdit(e, pack)}
                                                style={{ flexGrow: 1 }}
                                            >
                                                <EditIcon />
                                            </Button>
                                            <Button
                                                onClick={(e) => deletePackage(e, pack.id)}
                                                style={{ flexGrow: 1 }}
                                            >
                                                <DeleteIcon />
                                            </Button>
                            ...
                            <AccordionDetails>
                                <div>
                                    ...
                                    <Typography>
                                        {" "}
                                        Volumen: {pack.volume} m{m3}{" "}
                                    </Typography>
                                    <Typography>
                                        {" "}
                                        Coordenadas de destino: [ {pack.latitude} , {pack.longitude}{" "}
                                        ]{" "}
                                    </Typography>
                                    <Typography>
                                        {" "}
                                        Centro de distribución: {pack.storeId}{" "}
                                    </Typography>
                ...
                <div>
                    <Box height="14.5vh" mr={6}>
                        ...
                        >
                            ...
                            >
                                {1+page}/{Math.round(state.length/50)}{" "}
                            </Typography>
                            <Button disabled={page===0} onClick={() => router.push('/packages/'.concat((page-1).toString()))}>
                                <ArrowBackIos />
                            </Button>
                            <Button disabled={page===Math.round(state.length/50)-1} onClick={() => router.push('/packages/'.concat((page+1).toString()))}>
                                <ArrowForwardIos />
                            </Button>
                        </Grid>
                    </Box>
                ...
                >
                    ...
                    <DialogContent>
                        ...
                        <form
                            ...
                            noValidate
                            onSubmit={(e) => editPackage(e, formInfo.id)}
                        >
                            <TextField
                                variant="outlined"
                                margin="normal"
